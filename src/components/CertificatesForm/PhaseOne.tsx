  ...
  return (
    ...
    >
      ...
      <div className="grid w-3/4 grid-cols-1 gap-4 md:grid-cols-3">
        <Input
          name={props.currentLanguage === "pt" ? "Nome" : "Name"}
          registerReturn={register("pacientName")}
          error={errors.pacientName}
          type="text"
        />
        <Input
          name={props.currentLanguage === "pt" ? "Idade" : "Age"}
        ...
        <Input
          name={
            props.currentLanguage === "pt" ? "Data de Nascimento" : "Birth Date"
          }
      ...
      <div className="grid w-3/4 grid-cols-1 gap-4 md:grid-cols-3">
        <Select
          name={props.currentLanguage === "pt" ? "Sexo" : "Gender"}
        ...
        />
        <Input
          name={props.currentLanguage === "pt" ? "Peso" : "Weight"}
          registerReturn={register("pacientWeight")}
          error={errors.pacientWeight}
          type="text"
        />
        <Input
          name={props.currentLanguage === "pt" ? "Altura" : "Height"}
      ...
      <div className="grid w-3/4 grid-cols-1 gap-4 md:grid-cols-3">
        <Input
          name={
            props.currentLanguage === "pt" ? "Nome da Empresa" : "Company Name"
          }
        ...
        />
        <Input
          name={props.currentLanguage === "pt" ? "Função" : "Role"}
